...
public class Main {
	public static void main(String[] args) {
		...
		// 학생 생성
		Student student1 = new Student(1, "Alice", "Alice@emain.com");
		Student student2 = new Student(2, "BOb", "BOb@emain.com");
...
//		student1.setEnrollments(enrollment1); // <-- 통으로 List를 저장 하는 녀석
		// 학생의 기능을 이용
		...
		System.out.println("-----------------------");
		// 위 코드는 학생과 과목 을 Enrollment 클래스를 통해서 연결하는 예제 코드 이다
		
		//문제 3
		//Enrollment1 학생 정보와 과목 정보를 출력해 주세요
		// 학생 이름 : 이름
		//수강 과목 : 과목 이름
		// -------------
